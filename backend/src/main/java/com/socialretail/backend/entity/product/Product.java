...
public class Product {
    ...
    @Override
    public int hashCode() {
        return java.util.Objects.hash(id, brandId, merchantId, title, subTitle, mainImage, detailDesc, detailImages, saleType, status, auditStatus, auditRemark, auditTime, createTime, updateTime);
    }
}
