...
public class MerchantUpdateRequest {
    ...
    public boolean equals(Object o) {
        ...
        MerchantUpdateRequest that = (MerchantUpdateRequest) o;
    ...
    @Override
    public int hashCode() {
        return java.util.Objects.hash(merchantName, logo, contactName, contactPhone, shopAddress, businessHours, introduction);
    }
}
