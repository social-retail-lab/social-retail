...
public class ProductListVO {
    ...
    public boolean equals(Object o) {
        ...
        return java.util.Objects.equals(productId, that.productId)
                ...
                && java.util.Objects.equals(sales, that.sales)
    ...
    @Override
    public int hashCode() {
        return java.util.Objects.hash(productId, title, mainImage, minPrice, maxPrice, totalStock, sales, auditStatus, auditStatusText, status, statusText, createTime);
    }
}
